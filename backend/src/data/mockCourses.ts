export interface Course {
  ...
  domainName: string;
  provider: string; // e.g., "NSSTA Greater Noida", "Indian Statistical Institute (ISI)", "IIPS Mumbai", "CBC India"
  ...
  targetCompetencies: string[]; // e.g. ["Multi-stage Stratified Sampling", "Small Area Estimation"]
  competencyDelta: {
    domainId: 'statistical' | 'technical' | 'governance' | 'behavioural';
    gainPoints: number; // e.g. +14% score boost
