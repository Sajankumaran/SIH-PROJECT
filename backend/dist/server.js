...
import { MOCK_OFFICIALS } from './data/mockOfficials.js';
...
import { generateQuizFromText } from './ai/quizGenerator.js';
...
app.post('/api/officials/:id/simulate-completion', (req, res) => {
...
app.get('/api/courses/recommendations/:officialId', (req, res) => {
...
app.post('/api/quiz/generate', upload.single('documentFile'), (req, res) => {
    try {
        let rawText = '';
...
/* ==========================================================================
   ...
   ========================================================================== */
app.get('/api/trainer/assignments', (req, res) => {
    res.json({ success: true, data: trainerAssignments });
});
app.post('/api/trainer/assignments', (req, res) => {
    const newAssignment = {
        id: 'asg-' + Date.now(),
