...
export function getExplainableRecommendationsForOfficial(official) {
    ...
    for (const course of MOCK_COURSES) {
        ...
        let matchedSkill = domainComp?.skills.find(s => course.targetCompetencies.some(tc => s.name.toLowerCase().includes(tc.toLowerCase()) || tc.toLowerCase().includes(s.name.toLowerCase())));
